...
<body class="bg-gray-50">
    ...
    <div class="container mx-auto px-4 py-6 md:py-8">
        ...
        <div class="mb-6 md:mb-8">
            <h1 class="text-2xl md:text-3xl font-bold text-gray-800 mb-1">Dashboard</h1>
            <p class="text-gray-600 text-sm md:text-base">Selamat datang, <?= escapeHtml($_SESSION['nama']) ?> (<?= ucfirst($_SESSION['role']) ?>)</p>
        </div>
        ...
        <div class="grid grid-cols-2 lg:grid-cols-4 gap-3 md:gap-6 mb-6 md:mb-8">
            <div class="bg-white rounded-lg shadow p-4 md:p-6">
                <div class="flex items-center justify-between">
                    <div>
                        <p class="text-gray-500 text-xs md:text-sm mb-1">Total Aspirasi</p>
            ...
            <div class="bg-white rounded-lg shadow p-4 md:p-6">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-2xl md:text-3xl font-bold text-yellow-600"><?= $totalPending ?></p>
                    </div>
            ...
            <div class="bg-white rounded-lg shadow p-4 md:p-6">
                <div class="flex items-center justify-between">
                    <div>
                        <p class="text-gray-500 text-xs md:text-sm mb-1">Dalam Proses</p>
                        <p class="text-2xl md:text-3xl font-bold text-blue-600"><?= $totalProses ?></p>
                    </div>
                    <div class="bg-blue-100 p-2 md:p-3 rounded-full">
                        <svg class="w-6 h-6 md:w-8 md:h-8 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="bg-white rounded-lg shadow p-4 md:p-6">
                <div class="flex items-center justify-between">
                    <div>
                        <p class="text-gray-500 text-xs md:text-sm mb-1">Selesai</p>
                        <p class="text-2xl md:text-3xl font-bold text-green-600"><?= $totalSelesai ?></p>
                    </div>
        ...
        <div class="bg-white rounded-lg shadow">
            <div class="px-4 md:px-6 py-4 border-b border-gray-200 flex justify-between items-center">
                <h2 class="text-lg md:text-xl font-semibold text-gray-800">Aspirasi Terbaru</h2>
                <a href="list_aspirasi.php" class="text-blue-600 hover:text-blue-800 text-sm font-medium">Lihat Semua →</a>
            </div>
            <div class="p-4 md:p-6">
                <?php if (mysqli_num_rows($aspirasiTerbaru) > 0): ?>
                    <div class="space-y-3 md:space-y-4">
                        <?php while ($asp = mysqli_fetch_assoc($aspirasiTerbaru)): ?>
                            <div class="border border-gray-200 rounded-lg p-3 md:p-4 hover:bg-gray-50 transition">
                                <div class="flex justify-between items-start mb-2 gap-2">
                                    <h3 class="font-semibold text-gray-800 text-sm md:text-base flex-1"><?= escapeHtml($asp['judul']) ?></h3>
                                    <?php
                                    $statusColors = [
                                ...
                                <p class="text-gray-600 text-xs md:text-sm mb-2"><?= escapeHtml(substr($asp['deskripsi'], 0, 100)) ?>...</p>
                                <div class="flex flex-wrap justify-between items-center gap-1 text-xs text-gray-500">
                                    <span>
