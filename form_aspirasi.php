    ...
    <div class="container mx-auto px-4 py-6 md:py-8 max-w-3xl">
        ...
        <div class="bg-white rounded-xl shadow-lg p-5 md:p-8">
            <div class="mb-5 md:mb-6">
                <h1 class="text-2xl md:text-3xl font-bold text-gray-800 mb-1">Form Aspirasi Siswa</h1>
                <p class="text-gray-600 text-sm md:text-base">Sampaikan pengaduan atau masukan terkait sarana dan prasarana sekolah</p>
            </div>
            ...
            <form method="POST" action="" enctype="multipart/form-data">
                <div class="mb-5">
                    ...
                    <select name="kategori_id" id="kategori_id" required class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm md:text-base">
                ...
                <div class="mb-5">
                    ...
                    <input type="text" name="judul" id="judul" required maxlength="200"
                ...
                <div class="mb-5">
                    ...
                    <input type="text" name="lokasi" id="lokasi" required maxlength="100"
                        class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm md:text-base"
                ...
                <div class="mb-5">
                    ...
                    <textarea name="deskripsi" id="deskripsi" required rows="5"
                        class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm md:text-base"
                        placeholder="Jelaskan secara detail permasalahan yang ditemukan..."></textarea>
                ...
                <div class="mb-5">
                    ...
                    <input type="file" name="foto" id="foto" accept="image/jpeg,image/jpg,image/png,image/gif"
                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm file:mr-4 file:py-2 file:px-4 file:rounded-lg file:border-0 file:text-sm file:font-semibold file:bg-blue-50 file:text-blue-700 hover:file:bg-blue-100"
                        onchange="previewImage(event)">
                    <p class="text-gray-500 text-xs mt-1">Format: JPG, PNG, GIF. Maksimal 5MB</p>
                    <div id="imagePreview" class="mt-4 hidden">
                        <p class="text-sm font-semibold text-gray-700 mb-2">Preview:</p>
                        <img id="preview" src="" alt="Preview" class="w-full max-w-xs rounded-lg border border-gray-300 shadow-sm">
                    </div>
                </div>
                ...
                <div class="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-5">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-3 text-sm">
                        <div><span class="text-gray-600">Nama:</span> <span class="font-medium text-gray-800 ml-1"><?= escapeHtml($_SESSION['nama']) ?></span></div>
                        <div><span class="text-gray-600">Kelas:</span> <span class="font-medium text-gray-800 ml-1"><?= escapeHtml($_SESSION['kelas']) ?></span></div>
                        <div><span class="text-gray-600">Tanggal:</span> <span class="font-medium text-gray-800 ml-1"><?= date('d F Y') ?></span></div>
                    </div>
                </div>
                
                <div class="flex flex-col sm:flex-row gap-3">
                    <button type="submit" class="flex-1 bg-blue-600 hover:bg-blue-700 text-white font-semibold py-3 px-6 rounded-lg transition duration-200 text-sm md:text-base">
                        Kirim Aspirasi
                    </button>
                    <a href="histori_aspirasi.php" class="flex-1 bg-gray-300 hover:bg-gray-400 text-gray-800 font-semibold py-3 px-6 rounded-lg text-center transition duration-200 text-sm md:text-base">
                        Batal
                    </a>
                </div>
            </form>
